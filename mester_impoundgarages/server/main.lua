...
RegisterNetEvent("mester_impoundgarageGetVehicles", function(player, garage)
    ...
    TriggerClientEvent("mester_impoundgarageVehicles", player, vehicles, garage)
    end)
end)

RegisterNetEvent("mester_impoundgaragePay", function(plate, garage)
    moneyRemoved = false
    ...
    function(result)
        ...
        TriggerClientEvent("mester_impoundgarageSpawnVehicle", player, vehicle, garage)
        end)
    else
...
RegisterNetEvent("mester_impoundgarageImpoundVehicle", function(plate)
