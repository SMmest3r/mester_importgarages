...
function OpenImpoundMenu(garage)
  ...
  TriggerServerEvent("mester_impoundgaragesGetVehicles", playerId, garage)
end

RegisterNetEvent("mester_impoundgaragesVehicles", function(vehicles, garage)
...
RegisterNUICallback("pay", function(data)
  ...
  SendNUIMessage({
    ...
    SetNuiFocus(false, false)
    TriggerServerEvent("mester_impoundgaragesPay", plate, garage)
end)
...
RegisterNetEvent("mester_impoundgaragesSpawnVehicle", function(vehicle, garage)
if Config.Framework == "ESX" then
